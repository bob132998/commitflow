...
export default function EditMemberModal({
  ...
  // new state: isAdmin (boolean)
  const [isAdmin, setIsAdmin] = useState<boolean>(member?.isAdmin ?? false);
  ...
  async function handleSave(e?: React.FormEvent) {
    ...
    try {
      ...
      const payload: any = {
        ...
        role: role || null,
        photo: photoUrl ?? null,
        isAdmin, // include isAdmin in payload
      };
      ...
      const updated: TeamMember & { password?: string } = {
        ...
        isAdmin: payload.isAdmin ?? false, // ensure isAdmin carried over
      };
